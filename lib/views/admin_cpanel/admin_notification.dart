  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Notification List", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
        backgroundColor: const Color(0xFF44518A),
        centerTitle: true,
      ),
                ...
                child: Card(
                  ...
                  child: ListTile(
                    ...
                    trailing: ElevatedButton(
                      onPressed: notification.isActive ? () => _toggleNotificationStatus(notification) : null,
                      style: ElevatedButton.styleFrom(
                        backgroundColor: notification.isActive ? Colors.redAccent : Colors.grey,
                        padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(15),
                        ),
                      ),
                      child: const Text("Disable", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                    ),
                  ),
                ),
              );
